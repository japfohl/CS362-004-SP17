...
void TestFeast()
{
    ...
    // result = cardEffect(feast, smithy, -1, -1, game, 0, &bonus);
    ...
    // result = cardEffect(feast, province, -1, -1, game, 0, &bonus);
    ...
    result = cardEffect(feast, duchy, -1, -1, game, 0, &bonus);
    ...
    for (i = 0; i < 5; i++)
    {
        cardEffect(feast, duchy, -1, -1, game, i, &bonus);
    }
